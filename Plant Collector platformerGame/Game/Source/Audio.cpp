...
bool Audio::Awake(pugi::xml_node& config)
{
	...
	// Homework: control the volume with the xml_confiFile
...
// Load the volume state of audio
bool Audio::LoadState(pugi::xml_node& save_state)
{
	volume = save_state.child("volume").attribute("value").as_int();

	return true;
}

// Save the volume state of audio
bool Audio::SaveState(pugi::xml_node& save_state) const
{
	save_state.child("volume").attribute("value").set_value(volume);
